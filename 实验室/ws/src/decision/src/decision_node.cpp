...
public:
    ...
    void initializeTeamPoses() {
        // 红方增益区站点
        team_poses_.red_home.position.x = 2.9;
        team_poses_.red_home.position.y = -0.5;
        ...
        team_poses_.red_supply.position.x = 0.3;
        team_poses_.red_supply.position.y = -0.5;
        ...
        team_poses_.blue_supply.position.x = 5.25;
